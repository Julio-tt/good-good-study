...
public class GlobalSearchDialog1 implements ActionListener{
	JDialog s;
	...
	String T;
	JFrame ownedFrame;
	public GlobalSearchDialog1(JFrame frame,String a)
	{
		this.T=a;
		...
		updateMenu = new JMenuItem("录入");
		updateMenu.addActionListener(this);
		pop.add(updateMenu);
		deleteMenu = new JMenuItem("提交");
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		else if(e.getActionCommand().equals("提交"))
		{
			try{
				...
				//new GlobalSearchDialogT(ownedFrame,this.T).showDialog();
